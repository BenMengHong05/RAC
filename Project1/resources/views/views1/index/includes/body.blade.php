...
<section class="section">
    <div class="container-fluid">
        <div class="row blog-entries element-animate">
            @include('index.partials.siderbar')
            <div class="col-md-12 col-lg-8 main-content bg-light">
                <div class="scrol-down ">
                    <div class="scrol-text">
                        <div class="tamplate container-fluid "
                            style="position: relative;background-color: rgb(184, 190, 197)">
                            <div
                                class="col-md-12 col-lg-12  tamplate-text d-flex align-items-center justify-content-center gap-2">
                                <img src="{{ asset('images/_thumbnail-mit-dome_0.jpeg') }}" alt=""
                                    width="100px">
                        ...
                        <div class="scrol-down-text">
                            <div class="scrol-img">
                                <img src="{{ asset('images/MIT-Overturned-Ocean-SL.jpg') }}" alt=""
                                    width="100%">
                            </div>
                            <div>
                        ...
                        <div class="scrol-img container mt-5">
                            ...
                            <div class="row mt-5">
                                ...
                                <div class="col-md-12 col-lg-6">
                                    <img src="{{ asset('images/MIT-Cady-Coleman-SL.jpg') }}" alt=""
                                        width="100%">
                                    <div class="img-text mt-4">
                                        <h4>COMMUNITY SPOTLIGHT</h4>
                            ...
                            <div class="row mt-5">
                                <div class="col-md-12 col-lg-6">
                                    <img src="{{ asset('images/iStock-1313232216-home.jpg') }}" alt=""
                                        width="100%">
                                    <div class="img-text mt-4">
                                        <h4>RESEARCH</h4>
                                ...
                                <div class="col-md-12 col-lg-6">
                                    <img src="{{ asset('images/MIT-Stronger-Titanium-home.jpg') }}" alt=""
                                        width="100%">
                                    <div class="img-text mt-4">
                                        <h4>RESEARCH</h4>
                            ...
                            <div class="row mt-5">
                                <div class="col-md-12 col-lg-6">
                                    <img src="{{ asset('images/HERR-Nature-Medicine-Image-01-home.jpg') }}"
                                        alt="" width="100%">
                                    <div class="img-text mt-4">
                                        <h4>INNOVATION</h4>
                            ...
                            <div class="row ">
                                ...
                                <div class="footer-aboutMIT d-flex align-items-center ">
                                    <div class="col-md-12 col-lg-12  d-flex" style="justify-content: space-between">
                                        <h5 class="mt-2">Explore <span class="span-about"
                                                style="border-bottom: 2px solid red"> more spotlights,</span> or
                                            subscribe to receive <span class="span-about"
