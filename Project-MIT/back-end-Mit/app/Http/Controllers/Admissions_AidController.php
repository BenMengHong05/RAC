...
class Admissions_AidController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('content.post.admissions_aid.index')->with('admissions_aids', $admissions_aids); // Pass admissions_aids to the view
    }

    // Show the form to create a new admissions_aid
    public function create()
    {
        return view('content.post.admissions_aid.add_or_edit_admissions_aid');
    }
    ...
    public function show($id)
{
    ...
    return view('content.post.admissions_aid.view_admissions_aid')->with('admissions_aid', $admissions_aid);
}
...
public function edit($id){
    ...
    return view('content.post.admissions_aid.add_or_edit_admissions_aid', compact('admissions_aidEdit'));
}
...
public function search(Request $request)
{
    ...
    return view('content.post.admissions_aid.index')->with('admissions_aids', $admissions_aids);
}
}
