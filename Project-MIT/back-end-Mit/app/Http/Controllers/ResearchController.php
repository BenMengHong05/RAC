...
class ResearchController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('content.post.research.index')->with('researchs', $researchs); // Pass researchs to the view
    }

    // Show the form to create a new research
    public function create()
    {
        return view('content.post.research.add_or_edit_research');
    }
    ...
    public function show($id)
{
    ...
    return view('content.post.research.view_research')->with('research', $research);
}
...
public function edit($id){
    ...
    return view('content.post.research.add_or_edit_research', compact('researchEdit'));
}
...
public function search(Request $request)
{
    ...
    return view('content.post.research.index')->with('researchs', $researchs);
}
}
