...
class InnovationController extends Controller
{
    //
        ...
        public function index()
        {
            ...
            return view('content.post.innovation.index', compact('innovations')); // Pass to view
        }
        ...
        {
            return view('content.post.innovation.add_or_edit_innovation');
        }
        ...
        public function show($id)
    {
        ...
        return view('content.post.innovation.view_innovation')->with('innovation', $innovation);
    }
    ...
    public function edit($id){
        ...
        return view('content.post.innovation.add_or_edit_innovation', compact('innovationEdit'));
    }
    ...
    public function search(Request $request)
    {
        ...
        return view('content.post.innovation.index')->with('innovations', $innovations);
    }
}
