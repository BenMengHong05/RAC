            ...
            <div class="row">
                <div class="col-lg-7 d-flex flex-column align-items-start justify-content-start">
                    ...
                    <div class="row footer-ul-li-a gap-3 d-flex  w-100">
                        <ul class="col-lg-2 d-flex gap-4 ">
                            <li><a href="">Visit</a></li>
                            <li><a href="">Map</a></li>
                            <li><a href="">Events</a></li>
                        </ul>
                        <ul class="col-lg-9 d-flex gap-3 ">
                    ...
                    <div class="row footer-ul-li-a d-flex w-100">
                        <ul class="col-lg-4 gap-3 d-flex ">
                            <li><a href="">Privacy</a></li>
                            <li><a href="">Accessibility</a></li>
                            <li><a href="">Social Media Hub</a></li>
                        </ul>
                        <ul class="col-lg-7 gap-3 d-flex align-items-start justify-content-start">
