        ...
        <div class="container mt-5">
            <div class="row mt-2">
                ...
                <div class="col-lg-6 education-img" style="min-height: 40vh">
                    <div class="ed-img">
                        <img src="{{ asset('images/' . $researchs->image) }}" alt="Education Image" style="width: 60vh; height: 40vh;">
                    </div>
                </div>
            </div>
        </div>
...
<section class="container-fluid m-0 p-0 p-5 py-5  education-imgae mt-5  " style="background-color: #800000">
    <div class="container">
        <div class="row">
            <div class="col-lg-3">
                <figure>
                    <img src="{{asset('images/research1.jpg')}}" class="img-fluid img" alt="" style="width: 100%;height: 30vh;object-fit:cover">
                </figure>
            </div>
            <div class="col-lg-3">
                <figure>
                    <img src="{{asset('images/research2.jpg')}}" class="img-fluid img" alt="" style="width: 100%;height: 30vh;object-fit:cover">
                </figure>
            </div>
            <div class="col-lg-3">
                <figure>
                    <img src="{{asset('images/research3.jpeg')}}" class="img-fluid img" alt="" style="width: 100%;height: 30vh;object-fit:cover">
                </figure>
            </div>
            <div class="col-lg-3">
                <figure>
                    <img src="{{asset('images/research4..jpeg')}}" class="img-fluid img" alt="" style="width: 100%;height: 30vh;object-fit:cover">
                </figure>
            </div>
        </div>
        <div class="row py-2">
            <div class="col-lg-6">
                <figure>
                    <img src="{{asset('images/research5.jpeg')}}" class="img-fluid img"  alt="" style="width: 100%;height: 61.6vh;object-fit:cover">
                </figure>
            </div>
            <div class="col-lg-6">
            <div class="row">
                <div class="col-lg-6">
                    <figure>
                        <img src="{{asset('images/research6.jpeg')}}" class="img-fluid img" alt="" style="width: 100%;height: 30vh;object-fit:cover">
                    </figure>
                </div>
                <div class="col-lg-6">
                    <figure>
                        <img src="{{asset('images/research7.jpeg')}}" class="img-fluid img" alt="" style="width: 100%;height: 30vh;object-fit:cover">
                    </figure>
                </div>
            </div>
            <div class="row">
                <div class="col-lg-6 ">
                    <figure>
                        <img src="{{asset('images/research8.jpeg')}}" class="img-fluid img"  alt="" style="width: 100%;height: 30vh;object-fit:cover">
                    </figure>
                </div>
            </div>
            </div>
