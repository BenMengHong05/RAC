        ...
        <div class="scrol-text">
            <div class="tamplate container-fluid " style="position: relative;background-color: rgb(184, 190, 197)">
                <div class="col-md-12 col-lg-12  tamplate-text d-flex align-items-center justify-content-center gap-2">
                    ...
                    <a href="" class="text-decoration-none" style="border-bottom: 1px solid red" >Updates from campus:</a>
            ...
            <div class="scrol-down-text">
                <div class="scrol-img">
                    ...
                    <img src="{{ asset('images/' . $newmits->image) }}" class="img-fluid" alt="Education Image" style="width: 100%; height: 60vh;">
                </div>
                <div class="ps-4 mt-2" style="width: 15%">
                    <h1 style="font-family: 'Segoe UI', Tahoma, Geneva, Verdana, sans-serif;border-bottom: 1px solid red" style="width: 100%">{{$newmits->title}}</h1>
                </div>
                <div class="ps-4 mt-2">
