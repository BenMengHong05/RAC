                                    ...
                                    <p class="card-text">
                                        ...
                                        <form action="{{ isset($newmitEdit) && $newmitEdit->id ? route('newmit_update', $newmitEdit->id) : route('newmit_store') }}" method="POST" enctype="multipart/form-data">
                                            ...
                                            <div class="mb-3">
                                                ...
                                                <input type="text" class="form-control" value="{{ isset($newmitEdit) && $newmitEdit->id ? old('title', $newmitEdit->title) : '' }}" id="title" name="title" required>

                                                <label for="description" class="form-label">Description</label>
                                                <input type="text" name="description" id="description" class="form-control"
                                                value="{{ isset($newmitEdit) && $newmitEdit->id ? old('description', $newmitEdit->description) : old('description') }}" required>
                                            </div>
