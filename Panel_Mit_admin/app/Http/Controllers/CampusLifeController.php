...
class CampusLifeController extends Controller
{
    ...
    public function index(){
        ...
        return view("content.categories.campuslife.index")->with('campuslifes', $campuslifes);
    }
    public function create(){
        return view("content.categories.campuslife.add_or_edit_campuslife");
    }
    ...
    public function show($id){
        ...
        return view("content.categories.campuslife.view_campuslife")->with('campuslife', $campuslife);
    }


    public function edit($id){
        $campuslifeEdit = CampusLife::Find($id);
        return view('content.categories.campuslife.add_or_edit_campuslife', compact('campuslifeEdit'));
    }
    ...
    public function search(Request $request){
        ...
        return view('content.categories.campuslife.index')->with('campuslifes', $campuslife);
    }
}
