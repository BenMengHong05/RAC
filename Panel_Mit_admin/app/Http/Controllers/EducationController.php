...
class EducationController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('content.categories.education.index')->with('educations', $educations); // Pass educations to the view
    }

    // Show the form to create a new education
    public function create()
    {
        return view('content.categories.education.add_or_edit_education');
    }
    ...
    public function show($id)
{
    ...
    return view('content.categories.education.view_education')->with('education', $education);
}
...
public function edit($id){
    ...
    return view('content.categories.education.add_or_edit_education', compact('educationEdit'));
}
...
public function search(Request $request)
{
    ...
    return view('content.categories.education.index')->with('educations', $educations);
}
}
