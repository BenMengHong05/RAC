...
class NewMitController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('content.newmit.index')->with('newmits', $newmits); // Pass newmits to the view
    }

    // Show the form to create a new newmit
    public function create()
    {
        return view('content.newmit.add_or_edit_newmit');
    }
    ...
    public function show($id)
{
    ...
    return view('content.newmit.view_newmit')->with('newmit', $newmit);
}
...
public function edit($id){
    ...
    return view('content.newmit.add_or_edit_newmit', compact('newmitEdit'));
}
...
public function search(Request $request)
{
    ...
    return view('content.newmit.index')->with('newmits', $newmits);
}
}
